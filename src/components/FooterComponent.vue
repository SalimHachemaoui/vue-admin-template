      ...
      <div class="row">
        <div class="col-md-3 col-6">
          <ul style="list-style-type: none">
            ...
            <li><a class="footer-link font-weight-light" href="#">Blog</a><br></li>
            <li><a class="footer-link font-weight-light" href="#">Service</a><br></li>
            <li><a class="footer-link font-weight-light" href="#">sing in</a><br></li>
            <li><a class="footer-link font-weight-light" href="#">sing up</a><br></li>
          </ul>
        </div>
