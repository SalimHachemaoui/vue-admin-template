    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="option m-2">                    
                <input class="form-check-input" type="checkbox" id="use-datachannel" ref="UseDatachannel">
                <label class="form-check-label" for="use-datachannel">
                    Use datachannel
                </label>
                <select class="form-select" id="datachannel-parameters" ref="DatachannelParameters">
            ...
            <div class="option m-2">
                <input class="form-check-input" type="checkbox" id="use-audio" ref="UseAudio">
                <label class="form-check-label" for="use-audio">
                    Use audio
                </label>
                <select class="form-select" id="audio-codec" ref="AudioCodec">
            ...
            <div class="option m-2">
                ...
                <input class="form-check-input" type="checkbox" id="use-video" ref="UseVideo" checked>
                <label class="form-check-label" for="use-video">
                    Use video
                </label>
                <select class="form-select" id="video-resolution" ref="VideoResolution">
                    <option value="80x80" selected>80x80</option>
                ...
                <select class="form-select m-2" id="video-transform" ref="VideoTransform">
            ...
            <div class="option m-2">
                <input id="use-stun" ref="UseStun" type="checkbox" checked class="form-check-input"/>
                <label for="use-stun" class="form-check-label">Use STUN server</label>
            </div>
            ...
            <div id="media" ref="Media" style="display: none">
                ...
                <video id="video" ref="Video" autoplay="true" playsinline="true" controls style="height:410px;max-width:auto"></video>
            </div>
        </div>
        <!--div class="col">
            <h2>Data channel</h2>
    ...
    methods: {
        ...
        negotiate() {
            return this.pc.createOffer().then((offer) => {
                ...
                return fetch('http://20.224.173.226:8088/offer_cv', {
                    body: JSON.stringify({
                        sdp: offer.sdp,
                        type: offer.type,
